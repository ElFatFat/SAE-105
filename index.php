  ...
  <section>
    <div id="div_content_heroSection">
      ...
      <div id="div_heroSection_selector">
        <a onclick="selectorHero(1)">
          <div id="div_selector_one" class="active_selector"></div>
        </a>
        <a onclick="selectorHero(2)">
          <div id="div_selector_two" class=""></div>
        </a>
        <a onclick="selectorHero(3)">
          <div id="div_selector_three" class=""></div>
        </a>
      </div>
    </div>
